...
export const initialEventConfig: EventConfig = {
  ...
  eventType: 'Mis 15',
  subTitle: '15 años. Una noche. Mil momentos.',
  date: '2026-10-17T21:30:00-03:00',
  venue: 'Salón Don Ata Eventos',
  address: 'Rondeau 1165',
  city: 'Bahía Blanca, Buenos Aires',
  googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Sal%C3%B3n+Don+Ata+Eventos%2C+Rondeau+1165%2C+Bah%C3%ADa+Blanca',
  wazeUrl: 'https://www.waze.com/ul?q=Rondeau%201165%2C%20Bah%C3%ADa%20Blanca&navigate=yes',
  appleMapsUrl: 'https://maps.apple.com/?q=Rondeau+1165%2C+Bah%C3%ADa+Blanca',
  dressCode: 'Elegante sport',
  dressCodeDetails: 'Elegante sport: un look cuidado y cómodo para disfrutar toda la noche.',
  suggestedColors: ['Plata', 'Negro', 'Gris Plomo', 'Blanco', 'Brillos Metálicos'],
  forbiddenColors: ['Colores exclusivos de la Quinceañera'],
  cbu: '',
  cvu: '0000003100082213836807',
  alias: 'clara-2011',
  mpQrUrl: '',
  payPalUrl: '',
  theme: 'silver-disco',
  ...
  enableDressCode: false,
  enableGifts: true,
  enableGuestbook: true,
  enableTrivia: false,
  backgroundMusicUrl: 'https://www.youtube.com/watch?v=i2bu-UcVbiQ',
  ...
  gallery: [
    ...
    { id: 7, category: 'Book de 15', title: 'Clara · Sesión 144', url: 'gallery/144 - CLARA SESION.jpg', size: 'normal' },
  ],
};
