...
export const ProductLanding: React.FC = () => {
  ...
  const schema = useMemo(() => ({ '@context':'https://schema.org','@type':'Product',brand:{'@type':'Brand',name:'Evently'},name:'Invitación digital interactiva Evently',description:'Invitación digital personalizable con RSVP y panel de organización',offers:plans.map(plan => ({'@type':'Offer',priceCurrency:'ARS',price:plan.price.replace('.',''),availability:'https://schema.org/InStock'})) }), []);
  return <div className="min-h-screen bg-[#070707] text-white font-sans selection:bg-violet-300 selection:text-black">
    ...
    <footer className="border-t border-white/10 px-5 py-10"><div className="mx-auto flex max-w-7xl flex-col gap-4 text-sm text-zinc-500 sm:flex-row sm:items-center sm:justify-between"><p>© 2026 Evently. Experiencias digitales para celebrar.</p><div className="flex flex-wrap gap-5"><a href="#precios">Precios</a><a href="https://wa.me/5492916446200?text=Hola%20Evently%2C%20quiero%20crear%20una%20invitaci%C3%B3n" target="_blank" rel="noreferrer">WhatsApp</a><a href="mailto:pena_matias@hotmail.com">Email</a><a href="#contenido">Volver arriba</a></div></div></footer>
